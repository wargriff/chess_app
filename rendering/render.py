...
class ChessRenderer:
    def __init__(self, screen: pygame.Surface) -> None:
        ...
        self.subtitle_font = pygame.font.SysFont("Segoe UI", 24, bold=True)
    ...
    def board_origin(self) -> tuple[int, int]:
        ...
        x = (WINDOW_WIDTH - total) // 2 + (FRAME_PADDING // 2 if frame else 0)
    ...
    def draw_hud(self, status: str, mode: str, engine: str, buttons: dict[str, pygame.Rect]) -> None:
        ...
        self.screen.blit(status_surface, (24, hud_y + 52))

        mode_surface = self.small_font.render(mode, True, MUTED)
        self.screen.blit(mode_surface, (24, hud_y + 78))

        engine_surface = self.small_font.render(engine, True, ACCENT)
        self.screen.blit(engine_surface, (320, hud_y + 78))
    ...
    def draw_thinking_banner(self) -> None:
        ...
        rect = banner.get_rect(center=(WINDOW_WIDTH // 2, 24))
